...
$usuario = new Usuario();
$usuario->getUsuario($_GET['usuario_id']);
        ...
        <div class="button-container">
          ...
          <form class="form-inline">
            <div class="form-group col-md-9">
                <input type="text" class="form-control col-md-12" placeholder="Procurar Grupo Pelo Nome">
            </div>
            <button type="submit" class="btn btn-primary col-md-2">Pesquisar</button>
          </form>-->

        </div>
        <h3 class="title">Grupos de <?php echo $usuario->nome; ?></h3>
